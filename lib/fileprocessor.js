...
var FileProcessor = module.exports = function (type, patterns, finder, logcb, blockReplacements, grunt, encoding) {
  if (!type) {
...
FileProcessor.prototype.process = function (filename, assetSearchPath) {
  ...
  if (_.isString(filename)) {
    this.file = new File(filename, this.grunt, this.encoding);
  } else {
